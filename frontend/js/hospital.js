...
function makeAPIRequest(zipcode, radius) {
    ...
    let response = '[{"9name":"Example General Hospital","rating":{"Cultural Sensitivity":4.2,"Hospitality":1.3},"proximity":0.5},{"name":"Sample Text Hospital","rating":{"Cultural Sensitivity":2.6,"Hospitality":3.3},"proximity":1.9}]'
    $.post("http://localhost:3000/hospital-list",{"long":-122.41416,"lat":37.774929},function(data) {
        console.log(data);
